...
public class TileDatabase {
    private static final Tile[] Tiles = new Tile[]{
            ...
            new LootTile(new Sprite(AssetDatabase.GetTexture("square"), 16, 16), Color.PURPLE, 3, true),
            new LootTile(new Sprite(AssetDatabase.GetTexture("square"), 16, 16), Color.PINK, 4, true),
            new LootTile(new Sprite(AssetDatabase.GetTexture("square"), 16, 16), Color.LIME, 5, true),
